package com.nitroex.my_memo.utils.localization
...
open class LocalizationActivityDelegate(val activity: Activity) {
    ...
    private fun notifyLanguageChanged() {
        ...
        activity.startActivity(activity.intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
        activity.overridePendingTransition(R.anim.fade_in_real, R.anim.fade_out_real)
        activity.finish()
    }
